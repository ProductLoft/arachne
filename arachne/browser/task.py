...
from arachne.exceptions import InvalidTaskStatusTransition, TaskAlreadyCanceled
...
class TaskRequest(BaseModel):
    title: str | None = Field(
        ...
        examples=["Update goodreads with my latest read."],
    )

    steps: list[dict] = Field(
        default=[],
        description="The list of actions to be performed in the task.",
    )
    ...
    context: dict[str, Any] | list | str | None = Field(
        default=None,
        description="json object containing all the context needed for the task.",
        examples=[{"name": "John Doe", "email": "john@doe.com", "password": "password", "post_content": "Hello World"}],
    )
